...
},{"../core-js/object/get-own-property-descriptor":5,"../core-js/object/get-prototype-of":6}],13:[function(require,module,exports){
"use strict";
...
},{"../core-js/object/create":3,"../core-js/object/set-prototype-of":7,"../helpers/typeof":15}],14:[function(require,module,exports){
"use strict";
...
},{"../modules/core.get-iterator":86,"../modules/es6.string.iterator":95,"../modules/web.dom.iterable":99}],17:[function(require,module,exports){
require('../../modules/es6.object.assign');
module.exports = require('../../modules/_core').Object.assign;
},{"../../modules/_core":31,"../../modules/es6.object.assign":88}],18:[function(require,module,exports){
require('../../modules/es6.object.create');
var $Object = require('../../modules/_core').Object;
module.exports = function create(P, D){
  return $Object.create(P, D);
};
},{"../../modules/_core":31,"../../modules/es6.object.create":89}],19:[function(require,module,exports){
require('../../modules/es6.object.define-property');
var $Object = require('../../modules/_core').Object;
module.exports = function defineProperty(it, key, desc){
  return $Object.defineProperty(it, key, desc);
};
},{"../../modules/_core":31,"../../modules/es6.object.define-property":90}],20:[function(require,module,exports){
require('../../modules/es6.object.get-own-property-descriptor');
var $Object = require('../../modules/_core').Object;
module.exports = function getOwnPropertyDescriptor(it, key){
  return $Object.getOwnPropertyDescriptor(it, key);
};
},{"../../modules/_core":31,"../../modules/es6.object.get-own-property-descriptor":91}],21:[function(require,module,exports){
require('../../modules/es6.object.get-prototype-of');
module.exports = require('../../modules/_core').Object.getPrototypeOf;
},{"../../modules/_core":31,"../../modules/es6.object.get-prototype-of":92}],22:[function(require,module,exports){
require('../../modules/es6.object.set-prototype-of');
module.exports = require('../../modules/_core').Object.setPrototypeOf;
},{"../../modules/_core":31,"../../modules/es6.object.set-prototype-of":93}],23:[function(require,module,exports){
require('../../modules/es6.symbol');
require('../../modules/es6.object.to-string');
require('../../modules/es7.symbol.async-iterator');
require('../../modules/es7.symbol.observable');
module.exports = require('../../modules/_core').Symbol;
},{"../../modules/_core":31,"../../modules/es6.object.to-string":94,"../../modules/es6.symbol":96,"../../modules/es7.symbol.async-iterator":97,"../../modules/es7.symbol.observable":98}],24:[function(require,module,exports){
require('../../modules/es6.string.iterator');
require('../../modules/web.dom.iterable');
module.exports = require('../../modules/_wks-ext').f('iterator');
},{"../../modules/_wks-ext":83,"../../modules/es6.string.iterator":95,"../../modules/web.dom.iterable":99}],25:[function(require,module,exports){
...
},{"./_to-index":75,"./_to-iobject":77,"./_to-length":78}],29:[function(require,module,exports){
...
},{"./_an-object":27,"./_dom-create":35,"./_enum-bug-keys":36,"./_html":43,"./_object-dps":58,"./_shared-key":72}],57:[function(require,module,exports){
var anObject       = require('./_an-object')
...
},{"./_an-object":27,"./_descriptors":34,"./_ie8-dom-define":44,"./_to-primitive":80}],58:[function(require,module,exports){
var dP       = require('./_object-dp')
...
},{"./_array-includes":28,"./_has":41,"./_shared-key":72,"./_to-iobject":77}],65:[function(require,module,exports){
...
},{"./_an-object":27,"./_ctx":32,"./_is-object":47,"./_object-gopd":59}],71:[function(require,module,exports){
...
},{"./_classof":29,"./_core":31,"./_iterators":51,"./_wks":84}],86:[function(require,module,exports){
var anObject = require('./_an-object')
...
},{"./_an-object":27,"./_core":31,"./core.get-iterator-method":85}],87:[function(require,module,exports){
'use strict';
...
},{"./_add-to-unscopables":26,"./_iter-define":49,"./_iter-step":50,"./_iterators":51,"./_to-iobject":77}],88:[function(require,module,exports){
// 19.1.3.1 Object.assign(target, source)
var $export = require('./_export');

$export($export.S + $export.F, 'Object', {assign: require('./_object-assign')});
},{"./_export":38,"./_object-assign":55}],89:[function(require,module,exports){
var $export = require('./_export')
// 19.1.2.2 / 15.2.3.5 Object.create(O [, Properties])
$export($export.S, 'Object', {create: require('./_object-create')});
},{"./_export":38,"./_object-create":56}],90:[function(require,module,exports){
var $export = require('./_export');
// 19.1.2.4 / 15.2.3.6 Object.defineProperty(O, P, Attributes)
$export($export.S + $export.F * !require('./_descriptors'), 'Object', {defineProperty: require('./_object-dp').f});
},{"./_descriptors":34,"./_export":38,"./_object-dp":57}],91:[function(require,module,exports){
...
},{"./_object-gopd":59,"./_object-sap":67,"./_to-iobject":77}],92:[function(require,module,exports){
...
},{"./_object-gpo":63,"./_object-sap":67,"./_to-object":79}],93:[function(require,module,exports){
// 19.1.3.19 Object.setPrototypeOf(O, proto)
var $export = require('./_export');
$export($export.S, 'Object', {setPrototypeOf: require('./_set-proto').set});
},{"./_export":38,"./_set-proto":70}],94:[function(require,module,exports){
...
},{"./_iter-define":49,"./_string-at":74}],96:[function(require,module,exports){
'use strict';
...
},{"./_global":40,"./_hide":42,"./_iterators":51,"./_wks":84,"./es6.array.iterator":87}],100:[function(require,module,exports){
'use strict';
...
var Canvas = function () {
  ...
  (0, _createClass3.default)(Canvas, [{
    key: 'factory',
    value: function factory(shape, options) {
      var instance = new Shapes[shape](this.context, options);
    ...
    value: function clear() {
      this.context.clearRect(-this.offset.x / this.scale, -this.offset.y / this.scale, this.el.width / this.scale, this.el.height / this.scale);
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      try {
        for (var _iterator = (0, _getIterator3.default)(this.drawings), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
},{"./polygon":103,"./rect":104,"babel-runtime/core-js/get-iterator":1,"babel-runtime/helpers/classCallCheck":10,"babel-runtime/helpers/createClass":11}],101:[function(require,module,exports){
'use strict';
...
fetch(url).then(function (response) {
  ...
  try {
    for (var _iterator = (0, _getIterator3.default)(response), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      var color = legend[item.firecomp];
      var geometry = JSON.parse(item.geometry);
      var isNull = !item.firecomp;
      ...
      map.MultiPolygon(geometry.coordinates, {
  ...
  var legendEl = document.querySelector('details ul');
  var legendHTML = '';

  for (var key in legend) {
    legendHTML += '<li><img style="background-color: #' + legend[key] + ';">' + key + '</li>';
  }

  legendEl.innerHTML = legendHTML;

  // Init controls
  var downEl = document.querySelector('[data-js="controls"] > button:nth-of-type(3)');
  var leftEl = document.querySelector('[data-js="controls"] > button:nth-of-type(4)');
  var rightEl = document.querySelector('[data-js="controls"] > button:nth-of-type(2)');
  var upEl = document.querySelector('[data-js="controls"] > button:nth-of-type(1)');
  var zoomInEl = document.querySelector('[data-js="zoom"] button:nth-of-type(1)');
  var zoomOutEl = document.querySelector('[data-js="zoom"] button:nth-of-type(2)');
...
},{"./map":102,"babel-runtime/core-js/get-iterator":1}],102:[function(require,module,exports){
'use strict';
...
var Map = function () {
  function Map(canvas) {
    ...
    options.offset = options.offset ? (0, _assign2.default)({}, options.offset) : { x: 0, y: 0 };
    options.zoom = options.zoom || 1;

    this.canvas = new _canvas4.default(canvas);
  ...
  (0, _createClass3.default)(Map, [{
    key: 'point',
    value: function point(latitude, longitude) {
    ...
    value: function translate() {
      ...
      (_canvas = this.canvas).translate.apply(_canvas, arguments);
    }
  }, {
    key: 'zoom',
    value: function zoom() {
      ...
      (_canvas2 = this.canvas).zoom.apply(_canvas2, arguments);
    }
  }, {
    key: 'MultiPolygon',
    value: function MultiPolygon(polygons) {
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var _iteratorNormalCompletion = true;
      var _didIteratorError = false;
      var _iteratorError = undefined;
      ...
      try {
        for (var _iterator = (0, _getIterator3.default)(polygons), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    key: 'Polygon',
    value: function Polygon(coordinates) {
      var _this = this;
      ...
      options = (0, _assign2.default)({}, options);
      options.points = coordinates.map(function (point) {
        return _this.point(point[0], point[1]);
      });
...
},{"./canvas":100,"babel-runtime/core-js/get-iterator":1,"babel-runtime/core-js/object/assign":2,"babel-runtime/helpers/classCallCheck":10,"babel-runtime/helpers/createClass":11}],103:[function(require,module,exports){
'use strict';
...
var Polygon = function (_Shape) {
  ...
  function Polygon(context) {
    ...
    options = (0, _assign2.default)({}, options);
    options.points = Array.isArray(options.points) ? options.points.slice(0) : [];

    return (0, _possibleConstructorReturn3.default)(this, (Polygon.__proto__ || (0, _getPrototypeOf2.default)(Polygon)).call(this, context, options));
  }

  (0, _createClass3.default)(Polygon, [{
    key: 'render',
    value: function render() {
      (0, _get3.default)(Polygon.prototype.__proto__ || (0, _getPrototypeOf2.default)(Polygon.prototype), 'render', this).call(this);

      var context = this.context;
      var points = this.options.points.slice(0);
...
},{"./shape":105,"babel-runtime/core-js/get-iterator":1,"babel-runtime/core-js/object/assign":2,"babel-runtime/core-js/object/get-prototype-of":6,"babel-runtime/helpers/classCallCheck":10,"babel-runtime/helpers/createClass":11,"babel-runtime/helpers/get":12,"babel-runtime/helpers/inherits":13,"babel-runtime/helpers/possibleConstructorReturn":14}],104:[function(require,module,exports){
'use strict';
...
var Rect = function (_Shape) {
  (0, _inherits3.default)(Rect, _Shape);
  ...
  function Rect(context) {
    ...
    return (0, _possibleConstructorReturn3.default)(this, (Rect.__proto__ || (0, _getPrototypeOf2.default)(Rect)).call(this, context, options));
  }

  (0, _createClass3.default)(Rect, [{
    key: 'render',
    value: function render() {
      (0, _get3.default)(Rect.prototype.__proto__ || (0, _getPrototypeOf2.default)(Rect.prototype), 'render', this).call(this);
...
},{"./shape":105,"babel-runtime/core-js/object/assign":2,"babel-runtime/core-js/object/get-prototype-of":6,"babel-runtime/helpers/classCallCheck":10,"babel-runtime/helpers/createClass":11,"babel-runtime/helpers/get":12,"babel-runtime/helpers/inherits":13,"babel-runtime/helpers/possibleConstructorReturn":14}],105:[function(require,module,exports){
'use strict';
...
},{"babel-runtime/core-js/object/assign":2,"babel-runtime/helpers/classCallCheck":10,"babel-runtime/helpers/createClass":11}]},{},[101]);
